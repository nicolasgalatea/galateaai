...
const translations = {
  en: {
    ...
    'howItWorks.sectionTitle': 'Implementation Methodology',
    'howItWorks.sectionSubtitle': 'Four steps to transform your healthcare operations with autonomous AI agents',
    'howItWorks.card1.title': 'Bottleneck Diagnosis',
    'howItWorks.card1.desc': 'Process mining AI reveals hidden inefficiencies',
    'howItWorks.card2.title': 'Workflow Integration',
    'howItWorks.card2.desc': 'Secure connection to your legacy infrastructure',
    'howItWorks.card3.title': 'Agent Deployment',
    'howItWorks.card3.desc': 'Autonomous agents execute tasks 24/7',
    'howItWorks.card4.title': 'Control & Profitability',
    'howItWorks.card4.desc': 'Real-time ROI visibility',
    'howItWorks.viewMore': 'View more',
    'howItWorks.bottomCta': 'Enterprise Infrastructure for Healthcare Institutions',
  ...
  es: {
    ...
    'howItWorks.sectionTitle': 'Metodología de Implementación',
    'howItWorks.sectionSubtitle': 'Cuatro pasos para transformar sus operaciones de salud con agentes de IA autónomos',
    'howItWorks.card1.title': 'Diagnóstico de Cuellos de Botella',
    'howItWorks.card1.desc': 'IA de process mining revela ineficiencias ocultas',
    'howItWorks.card2.title': 'Integración de Flujos',
    'howItWorks.card2.desc': 'Conexión segura a su infraestructura legacy',
    'howItWorks.card3.title': 'Despliegue de Agentes',
    'howItWorks.card3.desc': 'Agentes autónomos ejecutan tareas 24/7',
    'howItWorks.card4.title': 'Control & Rentabilidad',
    'howItWorks.card4.desc': 'Visibilidad en tiempo real del ROI',
    'howItWorks.viewMore': 'Ver más',
    'howItWorks.bottomCta': 'Infraestructura Enterprise para Instituciones de Salud',
