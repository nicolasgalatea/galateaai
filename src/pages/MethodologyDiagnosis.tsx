      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="px-4 py-1 rounded-full bg-red-500/20 border border-red-500/30 text-red-400 text-sm font-medium">
              Paso 1 de 4
            </div>
          </div>

          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            Diagnóstico de <span className="text-red-400">Cuellos de Botella</span>
          </h1>
            ...
            <div className="bg-slate-900 rounded-xl p-6 border border-slate-700">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex flex-col items-center relative">
                  ...
                  <span className="text-xs text-red-400 mt-2">Facturación</span>
                </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/20 rounded-xl p-6">
              ...
              <p className="text-2xl font-bold text-red-400">$500K - $2M</p>
